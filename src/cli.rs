...
pub fn run(cli: Cli) {
    match cli.command {
        Commands::Train {
            ...
            negative_samples,
            model_type,
        } => handle_train(input, output, embeddings, config_path, dim, learning_rate, epochs, batch_size, window, negative_samples, model_type),
...
fn handle_similarity(word1: String, word2: String, model_path: String) {
...
fn handle_info(model_path: String) {
...
fn handle_export(model_path: String, output: String, format: String) {
